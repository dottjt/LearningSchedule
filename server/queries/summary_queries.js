...
function changeUsernameAllSummariesOfUser(username, updates) {
  return Summaries().update('username', username).update(updates);
}
...
module.exports = {
  ...
  changeUsernameAllSummariesOfUser: changeUsernameAllSummariesOfUser
};
