...
function render(input, out) {
  ...
  out.w("<section class=\"signup__container\"><h3 class=\"signup__header\">Learning Schedule</h3><h5 class=\"signup__header__two\">Welcome back.</h5><h3 class=\"signup__header__three " +
