...
function render(input, out) {
  ...
  out.w("<section class=\"signup__container\"><h3 class=\"signup__header\">Learning Schedule</h3><h5 class=\"signup__header__two\">Welcome back.</h5><form class=\"signup__form\" action=\"auth/login\" method=\"post\" accept-charset=\"utf-8\">");

  include_tag({
      _target: auth_form_template
    }, out);

  out.w("<div class=\"form-group\"><button class=\"btn btn-default register__form_submit--bottom\" type=\"submit\" action=\"\">Login</button></div></form></section>");
