**Note: This project is unfinished and will remain unfinished.** It's the very first full-stack web application I ever built, and considering I had literally zero idea how to build one, is a bit of a mess. Although I learnt an incredible amount from it.
