**Note: This project is unfinished and will remain unfinished.** It's the very first full-stack web application I ever built, and considering I had literally zero guidance (nor idea) on how to actually build one, is a bit of a mess.
